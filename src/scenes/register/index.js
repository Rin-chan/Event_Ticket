        ...
        <View style={[colorStyle.backgroundColorDefault, {flex: 1}]}>
            <SafeAreaView style={{flex: 1, margin: 20}}>
                <View style={{marginTop: 20, marginBottom: 20}}>
                    <Text style={[colorStyle.textColorPrimary, styles.title]}>Sign up for Tickme</Text>
                ...
                >
                    <Text style={colorStyle.textColorSecondary}>Already have account? </Text>
                    <Text style={[colorStyle.textColorPrimary, styles.boldText]}>Sign up</Text>
                </TouchableOpacity>
